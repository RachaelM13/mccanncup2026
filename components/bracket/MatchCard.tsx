...
export default function MatchCard({ match, compact = false, highlightTeamId }: MatchCardProps) {
    ...
    >
      ...
      <div className={`${compact ? 'p-2' : 'p-3'}`}>
        ...
        <TeamRow
          ...
          isLoser={isCompleted && match.winner_id !== null && match.winner_id !== match.home_team_id}
        ...
        {/* Divider */}
        <div className={`${compact ? 'my-1' : 'my-2'} border-t border-border/50`} />
        ...
        <TeamRow
          ...
          isLoser={isCompleted && match.winner_id !== null && match.winner_id !== match.away_team_id}
...
function TeamRow({ team, score, isWinner, isLoser, isHighlighted, compact, showScore }: TeamRowProps) {
  return (
    <div
    ...
    >
      <div className="flex items-center gap-2 min-w-0">
        <span className={compact ? 'text-base' : 'text-lg'} role="img">
          {team?.flag ?? '🏳️'}
        </span>
        <span
